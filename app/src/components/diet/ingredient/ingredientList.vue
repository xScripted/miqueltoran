    ...
    <div class="container-fluid">
        <div class="row">
            ...
            @click="$bvModal.show('modal-ingredient-' + ingredient._id)">
                ...
                <b-modal size="lg" hide-footer :title="ingredient.nombre + ' ~ ' + ingredient.valoracion + '/100'" :id="'modal-ingredient-' + ingredient._id">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-sm-3 element" v-for="(x, k) in ingredient.macros" :key="k">
                                <b-form-group :label="capitalize(k)">
                                    <b-form-input id="input-12" type="number" :value="x" disabled></b-form-input>
                                </b-form-group>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-2 element" v-for="(x, k) in ingredient.micros.vitaminas" :key="ingredient._id + k">
                                <b-form-group :label="capitalize(k)">
                                    <b-form-input id="input-12" type="text" :value="x" disabled></b-form-input>
                                </b-form-group>
                            </div>
